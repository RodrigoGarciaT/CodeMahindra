...
const PodiumView: React.FC<PodiumViewProps> = ({ topUsers }) => {
  // Ordenamos a los usuarios por experiencia (desc) y tomamos los primeros 3
  const podiumUsers = [...topUsers]
    .sort((a, b) => b.experience - a.experience)
    .slice(0, 3)

  // Verificación de usuarios en el podio
          ...
          <div className="absolute inset-0 z-20">
            ...
            {second && (
              <div className="absolute bottom-[200px] left-[calc(50%-190px)] w-[180px] flex flex-col items-center transform -translate-x-1/2">
                ...
                >
                  <div className="relative">
                    ...
                    <div className="absolute -right-2 -bottom-1 w-10 h-10 rounded-md overflow-hidden border-2 border-gray-800 shadow-lg">
                      <img
                        src={second.flag || "https://static.vecteezy.com/system/resources/thumbnails/007/095/871/small/usa-realistic-waving-flag-illustration-national-country-background-symbol-independence-day-free-vector.jpg"}
                        alt="Flag"
                ...
                >
                  <p className="text-white text-xl font-bold">{second.name}</p>
                </motion.div>
                <motion.div
                  initial={{ opacity: 0, y: 10 }}
                  animate={{ opacity: 1, y: 0 }}
                ...
                >
                  <div className="bg-gradient-to-r from-red-600 to-red-500 text-white px-5 py-2 rounded-full shadow-lg border border-red-400">
                    <p className="text-center font-bold whitespace-nowrap">
                      {second.experience.toLocaleString()} XP
                    </p>
                  </div>
                </motion.div>
              </div>
            ...
            {first && (
              <div className="absolute bottom-[260px] left-1/2 w-[180px] flex flex-col items-center transform -translate-x-1/2">
                ...
                >
                  <div className="relative">
                    ...
                    <div className="w-20 h-20 bg-[#d1f0e8] rounded-full flex items-center justify-center p-1 shadow-lg">
                      <img
                        src={first.avatar || "/placeholder.svg?height=80&width=80"}
                        alt={first.name}
                        className="w-full h-full rounded-full object-cover"
                      />
                    </div>
                    ...
                    <div className="absolute -right-2 -bottom-1 w-10 h-10 rounded-md overflow-hidden border-2 border-gray-800 shadow-lg">
                      <img
                        src={first.flag || "https://static.vecteezy.com/system/resources/thumbnails/007/095/871/small/usa-realistic-waving-flag-illustration-national-country-background-symbol-independence-day-free-vector.jpg"}
                        alt="Flag"
                        className="w-full h-full object-cover"
                      />
                    </div>
                ...
                <motion.div
                  ...
                  transition={{ duration: 0.3, delay: 0.4 }}
                >
                  <p className="text-white text-xl font-bold">{first.name}</p>
                </motion.div>
                <motion.div
                  initial={{ opacity: 0, y: 10 }}
                  animate={{ opacity: 1, y: 0 }}
                ...
                >
                  <div className="bg-gradient-to-r from-red-600 to-red-500 text-white px-5 py-2 rounded-full shadow-lg border border-red-400">
                    <p className="text-center font-bold whitespace-nowrap">
                      {first.experience.toLocaleString()} XP
                    </p>
                  </div>
                </motion.div>
              </div>
              ...
              <div className="absolute bottom-[160px] left-[calc(50%+190px)] w-[180px] flex flex-col items-center transform -translate-x-1/2">
                ...
                >
                  <div className="relative">
                    ...
                    <div className="absolute -right-2 -bottom-1 w-10 h-10 rounded-md overflow-hidden border-2 border-gray-800 shadow-lg">
                      <img
                        src={third.flag || "https://static.vecteezy.com/system/resources/thumbnails/007/095/871/small/usa-realistic-waving-flag-illustration-national-country-background-symbol-independence-day-free-vector.jpg"}
                        alt="Flag"
                        className="w-full h-full object-cover"
                      />
                    </div>
                ...
                <motion.div
                  ...
                  transition={{ duration: 0.3, delay: 0.4 }}
                >
                  <p className="text-white text-xl font-bold">{third.name}</p>
                </motion.div>
                <motion.div
                  initial={{ opacity: 0, y: 10 }}
                  animate={{ opacity: 1, y: 0 }}
                ...
                >
                  <div className="bg-gradient-to-r from-red-600 to-red-500 text-white px-5 py-2 rounded-full shadow-lg border border-red-400">
                    <p className="text-center font-bold whitespace-nowrap">
                      {third.experience.toLocaleString()} XP
                    </p>
                  </div>
                </motion.div>
              </div>

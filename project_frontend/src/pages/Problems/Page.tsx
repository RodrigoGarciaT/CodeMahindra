      ...
      <div className="flex gap-8">
        ...
        <div className="flex-1">
          ...
          <section className="my-0">
            <h2 className="text-2xl font-bold text-white mb-6">Active Code Challenges</h2>
              ...
              <div className="overflow-hidden">
                <div className="flex gap-6" style={slideTransition}>
                  {activeProblems.map((problem) => (
                    <div
                      key={problem.id}
                      className="flex-none w-full sm:w-1/2 lg:w-1/3 cursor-pointer"
          ...
          <div
            onClick={goToRoadMap}
            className="flex justify-between items-center p-4 rounded-xl bg-gradient-to-r from-red-600 to-red-400 text-white shadow-md w-full my-6 cursor-pointer transition-transform hover:scale-[1.01]"
          >
            <div className="px-12 py-2">
              <p className="font-semibold text-2xl">Not sure what to study to level up?</p>
              <p className="mt-1 text-2xl">Explore our curated roadmap and start improving today</p>
            </div>
            <div className="bg-red-500 hover:bg-red-600 transition-colors p-3 rounded-xl">
              <svg
